...
*/
- (void)SetLayoutAnimated:(int)DurationMS :(float)DumpingRatio :(float)Left :(float)Top :(float)Width :(float)Height;
...
//Returns the text selection start index.
- (int)SelectionStart;
...
//Removes the current top page from the stack.
